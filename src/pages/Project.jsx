...
function Project() {
  return (
    <div className="h-[200vh] flex flex-col justify-evenly align-middle bgimagegradient  ">
      <div className=" flex justify-center align-middle p-[20px] xl:p-[40px]">
        <div className="w-[50%] z-[2]">
          <h5 className="text-[#a471e1] text-[20px] text-bold ">
            Featured Project
          </h5>
          <h1>Example Project</h1>
          <p className="  p-[20px] bgprojectp relative 2xl:p-[30px] 2xl:w-[90%] ]">
      ...
      <div className=" flex justify-center align-middle p-[20px] ">
        ...
        <div className="w-[50%] z-[2] text-right ">
          ...
          <h1>Example Project</h1>
          <p className="  p-[20px] bgprojectp2 relative  text-left 2xl:p-[30px] 2xl:w-[90%] 2xl:right-[-10%] ">
            A web app for visualizing personalized Spotify data. View your top
            artists, top tracks, recently played tracks, and detailed audio
            information about each track. Create and save new playlists of
            recommended tracks based on your existing playlists and more.
